/***************************************************************************//**
 *  @file
 *  @brief An array A consisting of N integers is given. Rotation of the array 
 *  means that each element is shifted right by one index, and the last element
 *  of the array is moved to the first place. For example, the rotation of array 
...
#ifndef __CYCLIC_ROTATION_H__
#define __CYCLIC_ROTATION_H__
